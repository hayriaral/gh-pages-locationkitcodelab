...
## Introduction
    Activity Identification and Geofence codelab encapsulates APIs of the HUAWEI Location Kit SDK. It provides many sample programs for your reference or usage.
    Before you use this codelab, it's assumed that you already have a HUAWEI developer account and have already created an app to implement the HMS Location Kit. If you haven't, please refer to https://developer.huawei.com/consumer/en/doc/start/introduction-0000001053446472 and https://developer.huawei.com/consumer/en/doc/development/AppGallery-connect-Guides/agc-introduction.
    
    data:		The package name which refers models and repositories.
    ui:			The package name which shows the interface of the app to the user.
    util:		The package name which holds permission handling, extensions, constants and broadcast receiver cla
    viewmodel:	The package name which represents viewmodels.

## Installation
    Before using Activity Identification and Geofence codelab, check whether the Android Studio environment has been installed. 
    Download the project by zip or clone in GitHub.
...
## Configuration 
    ...
    3. Go to Project Settings > Manage APIs, find the Location Kit API, and enable it.
    ...
    8. Configure the dependency 'com.huawei.hms:location:5.0.4.300' in the app-level buildle.gradle file.
    9. Synchronize the project.

## Sample Code
    Activity Identification and Geofence codelab code uses the Client structure in the project.The following describes methods in the Client structure.
...
##  License
    Activity Identification and Geofence codelab is licensed under the [Apache License, version 2.0](http://www.apache.org/licenses/LICENSE-2.0).
